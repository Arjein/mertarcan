        ...
        >
          <div className="text-center mb-12">
            ...
            <motion.h1
              ...
              className="text-7xl md:text-8xl font-bold mb-8 tracking-tight text-gradient"
            >
              About Me
            </motion.h1>
            <motion.p
              ...
              className="text-2xl text-on-surface/70 max-w-3xl mx-auto font-light"
            >
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-surface/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-500 border border-on-surface/10"
            >
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-on-primary text-2xl mr-4">
                  🎓
                </div>
